                    ...
                    <p>
                        ...
                        <Row>
                            ...
                            <Col md={{span: "24"}} lg={{span: "12"}} style={{textAlign: 'right'}}>
                                <b style={{fontSize: "18px", color: "green"}}>10</b>
                            </Col>
                        </Row>
                        <Row>
                            <Col md={{span: "24"}} lg={{span: "12"}}>
                            ...
                            <Col md={{span: "24"}} lg={{span: "12"}} style={{textAlign: 'right'}}>
                                <b style={{fontSize: "18px", color: "green"}}>1 000 000 F</b>
                            </Col>
                        </Row>
                    </p>
                </Card>
                ...
                <Card style={{ width: "70%", minWidth: "200px", margin: "10px", borderRadius: "15px", backgroundColor: "#B1B2B5" }}>
                    <p>
                        ...
                        <Row>
                            ...
                            <Col md={{span: "24"}} lg={{span: "12"}} style={{textAlign: 'right'}}>
                                <b style={{fontSize: "18px", color: "green"}}>40</b>
                            </Col>
                        </Row>
                        <Row>
                            <Col md={{span: "24"}} lg={{span: "12"}}>
                            ...
                            <Col md={{span: "24"}} lg={{span: "12"}} style={{textAlign: 'right'}}>
                                <b style={{fontSize: "18px", color: "green"}}>2 000 000 F</b>
                            </Col>
                        </Row>
                    </p>
                </Card>
